...
x_axis=np.array([[952,2,1,65],[1244,3,2,64],[1974,3,2,17]])
...
def gradient_desent(w_in,b_in,x,y,nums,alpha):
    ...
    for i in range(nums):
        ...
        w=w-alpha*jw
    return w,b
print(gradient_desent(w,0,x_axis,y_axis,10000,1e-7))
print(func_cost([ 0.25325712, -0.01578966, -0.01562902, -0.31193121],-0.000642588207044559,x_axis,y_axis))
print(func([6874,6,6,60],[ 0.25325712, -0.01578966, -0.01562902, -0.31193121],-0.000642588207044559))